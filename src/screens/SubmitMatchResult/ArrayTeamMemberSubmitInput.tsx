...
import { PlayerInput } from "../OrganizerScreens/UpdateMatchResult/ArrayTeamMemberInput";
...
interface ArrayTeamMemberSubmitInputProps {
  players: PlayerInput[];
...
export default function ArrayTeamMemberSubmitInput({
  onChangeValue,
  players,
  header,
  teamMemberOptions,
  userIdData,
}: ArrayTeamMemberSubmitInputProps) {
  const {
    control,
    handleSubmit,
      ...
      >
        <VStack space="2">
          <VStack
            ...
            px="4"
          >
            {player.shouldUseDefaultValue ? (
              <HStack justifyContent="space-between" alignItems="center" h="12">
                <VStack space="1">
          ...
          {isOtherType && !player.shouldUseDefaultValue && (
            <VStack p="2" space="3">
              <FormInput
                onChangeText={(value) => {
                ...
                return {
                  ...
                  type:
                    value === t("Other")
                      ...
                      : PlayerInputType.Selection,
                  shouldUseDefaultValue: false,
                  userId: userIdResult.userId || findResult?.userId,
                };
              }
