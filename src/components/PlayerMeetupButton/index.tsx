...
export type PlayerMeetupButtonProps =
  BottomTabScreenProps<PlayerBottomTabNavigatorParamList>;

const t = getTranslation("component.PlayerMeetupButton");
...
export default function PlayerMeetupButton({
  navigation,
}: PlayerMeetupButtonProps) {
  ...
  const [currentRoute, setCurrentRoute] =
    useState<keyof PlayerBottomTabNavigatorParamList>("PlayerHome");
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener("state", (e) => {
      setCurrentRoute(
        ...
        ].name as keyof PlayerBottomTabNavigatorParamList
      );
    });
    return unsubscribe;
  }, [navigation]);
    ...
    <Box justifyContent="center" alignItems="center">
      ...
      >
        <TabNavigatorIcon
          ...
          onPress={() => {
            triggerAnimation();
            // TODO: to be deleted when there is a related screen implemented
