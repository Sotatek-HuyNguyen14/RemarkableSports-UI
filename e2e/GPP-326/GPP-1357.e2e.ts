...
describe("[GPP-1357]: Usecase player login", () => {
  beforeEach(async () => {
  ...
  it("[GPP-1358]: Player login successfully", async () => {
    // Preconditions
    // Email and passwords are VALID
    // Email and passwords for Player account
  ...
  it("[GPP-1358]: Player login failed", async () => {
    // Preconditions
